...
description: Thermo-nuclear branch audit (bugs, breaking changes, security, devex, feature-flag leaks) scoped to the diff — same posture as web Deep review. Invoked via Task after a parent gathers diff and file contents. Loads rubric from .cursor/skills/shipping/thermo-nuclear-review/SKILL.md.
---
...
1. Read `.cursor/skills/shipping/thermo-nuclear-review/SKILL.md` and follow it exactly: scope (only added/modified code), breaking functionality and devex, feature leaks, intended breakage, over-reporting, final response / PR discussion rules, critical rules.
